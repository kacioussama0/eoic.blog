...
<div class="card rounded-4 border-0 mb-3 shadow overflow-hidden" style="min-height: 300px;">
    ...
    <div class="card-footer bg-transparent d-flex border-top-0" style="font-size: 25px;height: 55px">
        <div>
            <span style="font-size: 18px" >
                  <button class="bg-transparent border-0 me-3" type="button" data-bs-toggle="collapse" data-bs-target="#post{{$post->id}}" aria-expanded="false" aria-controls="{{$post->id}}">
                    <i class="fa-regular fa-share me-1 pe-auto"></i>
                </button>
